if( NOT __MULLE_SPRINTF_DEPENDENCIES_AND_LIBRARIES_CMAKE__)
   set( __MULLE_SPRINTF_DEPENDENCIES_AND_LIBRARIES_CMAKE__ ON)
   ...
   #
   #if( MSVC)
   #   set( MULLE_SPRINTF_DEFINITIONS $<|PARENT_IDENTIFIER|>_DEFINITIONS})
   #endif()
endif()
