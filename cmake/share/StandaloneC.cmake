if( NOT __STANDALONE_C_CMAKE__)
   ...
   if( STANDALONE)
      ...
      if( NOT STANDALONE_NAME)
         set( STANDALONE_NAME "mulle-sprintf-standalone")
      endif()
      set( STANDALONE_DEFINITIONS ${MULLE_SPRINTF_DEFINITIONS})
...
mulle-sprintf-standalone.c with contents like this to it:
   int  ___mulle_sprintf_unused__;
and everybody will be happy")
         ...
         add_dependencies( ${STANDALONE_NAME} mulle-sprintf)
         if( STARTUP_NAME)
